/*
 * Card imagery is bundled rather than hotlinked. The previous remote URLs
 * pointed at Unsplash, which now returns 403 to hotlinks — two cards silently
 * fell back to the placeholder. Local imports can't rot, work offline, and get
 * fingerprinted + optimised by Vite.
 *
 * All three are Wikimedia Commons, CC BY-SA 4.0 — attribution is required:
 *   q4-results.jpg       Bajaj-NS400Z.jpg by HiveMynd
 *   chetak-milestone.jpg Bajaj Chetak electric scooters (2026) 01.jpg by Gpkp
 *   chakan-rnd.jpg       Digitale lösungen smart factory.jpg by EngelGMA
 */
import q4Results from '@/assets/news/q4-results.jpg'
import chetakMilestone from '@/assets/news/chetak-milestone.jpg'
import chakanRnd from '@/assets/news/chakan-rnd.jpg'
...
export const newsMock = {
  getAll() {
    return [
      {
        id: '1',
        headline: 'Bajaj Auto Records Strongest Q4 in History',
        excerpt:
        ...
        body: [
          ...
          'MD Rajiv Bajaj credited the results to the company\'s focused portfolio strategy and supply chain resilience built over the past two years. The board has recommended a dividend of ₹140 per share for FY2026.',
        ],
      },
      {
        id: '2',
        headline: 'Chetak EV Crosses 1 Lakh Sales Milestone',
        excerpt:
          "The Chetak electric scooter has crossed 1,00,000 cumulative sales, marking a significant milestone for Bajaj's EV journey.",
        date: '2026-04-15',
        sourceTag: 'Product',
        image: chetakMilestone,
        body: [
          ...
          'The EV team will celebrate this milestone with a customer appreciation event across seven cities in May. Employees who contributed to the Chetak programme will be recognised at the upcoming All-Hands.',
        ],
      },
      {
        id: '3',
        headline: 'New R&D Facility Inaugurated at Chakan',
        excerpt:
        ...
        body: [
          ...
          'Over 200 engineers from the R&D, product engineering, and quality teams have been co-located at the facility. The inauguration was attended by senior leadership and state government representatives, who highlighted the investment as a signal of Bajaj\'s long-term commitment to Pune\'s automotive ecosystem.',
        ],
      },
    ]
  },
