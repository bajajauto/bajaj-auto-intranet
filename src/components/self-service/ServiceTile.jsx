...
const tileStyles = {
  ...
  'parental-leave':   'from-[#1665C0] to-[#0E3E88]',
...
export default function ServiceTile({ id, label, icon, redirectUrl }) {
  ...
  return (
    <button
      ...
      aria-label={label}
    >
      <span className={`relative z-10 flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${badge} shadow-sm transition-transform duration-200 group-hover:scale-110`}>
