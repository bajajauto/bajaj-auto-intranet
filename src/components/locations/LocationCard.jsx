...
export default function LocationCard({ name, subLocations }) {
  ...
  return (
    <div className="site-surface-interactive w-full rounded-card border overflow-hidden transition-all duration-200 hover:shadow-modal hover:-translate-y-0.5">
